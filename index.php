	...
	<main>
		...
		<section name="productos" class="portfolio">
			<header class="heading">
				<h2><span class="icon-codepen right"></span>Productos</h2>
			</header>
		...
		<section name="blog">
			...
			<div class="Panel--contenedor">
				<article class="Panel">
					...
					<div class="Panel--contenido">
						...
						<a href="blog.php" class="boton">Leer más ...</a>
					</div>
				</article>
			</div>
			...
			<div class="Panel--contenedor">
				<div class="Panel-small">
					<figure>
						<a href="#"><img src="img/webmoderna-propaganda.jpg" alt="algo" /></a>
					</figure>
		...
		<section name="about_us" class="Vidriera-2">
			<header class="heading">
				<h2>Acerca de Nosotros</h2>
			</header>
			<article class="Vidriera-2--estante">
				<div class="etiqueta">
					<span class="icon-star right"></span>Oferta
				</div>
				<figure class="imagen">
				...
				<div class="contenido">
					<h3>De los Palotes, Juan</h3>
					<p>Asesino a sueldo de mosquitos picadores provenientes de Las Bermudas. También luthier de los Les Luthiers</p>
				</div>
			</article>
			<article class="Vidriera-2--estante">
				<figure class="imagen">
				...
				<div class="contenido">
					<h3>Esteban Quito</h3>
					<p>Vendedor especializado por su capacidad banquera orientado a las inmobiliarias, los restaurantes y manualidades honestas.</p>
				</div>
			</article>
			<article class="Vidriera-2--estante">
				<figure class="imagen">
				...
				<div class="contenido">
					<h3>Poly Poly</h3>
					<p>Dueño de inmobiliaria, requetesuper inmobiliarero empedernido y un poquito de martillero privado (no tan público)</p>
				</div>
			</article>
			<article class="Vidriera-2--estante">
				<figure class="imagen">
				...
				<div class="contenido">
					<h3>Sarita Rita Rita</h3>
					<p>Nueva mamá proveniente de un pueblo cercano de por aquí. Mmmm...demasiado cerca para ser exacto.</p>
				</div>
			</article>
			<article>
				<blockquote>
		...
		<section class="Vidriera" name="servicios">
			<header class="heading">
				<h2>Servicios</h2>
			</header>
			<article class="Vidriera--estante">
				<figure class="imagen">
					<img src="img/divi2-blurb-1.jpg" alt="foto" />
				</figure>
				<div class="contenido">
